...
namespace ProjectDevKitchenNew
{
    ...
    public class Game2 : Game
    {
        ...
        Vector2 positionKitchenChief;
        Vector2 positionCooker;
        ...
        protected override void LoadContent()
        {
            ...
            positionCooker = new Vector2(96, 368);
            positionWasher = new Vector2(0, 0);
        }
            ...
            for (int numLayer = 0; numLayer < nbLayers; numLayer++)
            {
                for (var i = 0; i < map.Layers[numLayer].Tiles.Count; i++) //on compte le nombre de Tiles nécessaire pour faire la map.
                {
                    ...
                    else
                    {
                        ...
                        spriteBatch.Draw(textureCooker, positionCooker, Color.White);
